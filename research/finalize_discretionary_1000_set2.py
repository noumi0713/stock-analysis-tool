...
CTX = ROOT / 'discretionary_review_1000_set2_context.csv'
OVR = ROOT / 'discretionary_review_1000_set2_manual_overrides.csv'
OUT = ROOT / 'discretionary_review_1000_set2_final.csv'
SUMMARY = ROOT / 'discretionary_review_1000_set2_final_summary.json'
QA = ROOT / 'discretionary_review_1000_set2_qa_sample.csv'
