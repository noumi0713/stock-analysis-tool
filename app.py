...
# --- アプリ設定 ---
st.set_page_config(page_title="国策銘柄スクリーナー", layout="wide")
...
if ts_list:
    ...
    mode = st.radio("モード選択:", ["通常モード", "厳格モード（上昇トレンド限定）"], index=1)
