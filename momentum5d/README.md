...
出来高0または価格が無効な行を取引不能として除外し、過去5営業日以内に高値が+5%へ到達した場面を時系列順に学習します。現在の主ランキングは、急落継続・投げ売り反転・緩やかな底固めの3形状、売買代金2億円以上、形状別HistGradientBoostingの+5%確率55%以上、−5%確率50%以下、−8%確率30%以下を満たす銘柄から、期待損益と下落確率を含むスコアで1日最大1銘柄だけを選びます。該当なしの日は空ランキングとし、翌日寄付きが前日終値比+3%を超えた場合はエントリー対象外です。市場地合いと決算・重要指標リスクは別の注意情報として残します。
