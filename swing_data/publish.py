...
def publish(source: Path, target: Path) -> None:
    ...
    text = ("# 日本株120営業日・チャッピー分析用\n\n"
            ...
            f"9. [スワイプ選別母集団]({PUBLIC}/swipe_review_universe.json)と[スワイプ選別状態]({PUBLIC}/swipe_review_status.json)を確認する。母集団は全東証銘柄の最新終値×出来高で算出した推計売買代金ランキング上位100銘柄。画面表示順は直近6営業日の調整後終値から5営業日騰落率をその場で計算して降順にする。\n"
